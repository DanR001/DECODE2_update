...
print(">>> Initializing SatGen ...")

#---cosmology
# changed to my parameters (Planck 2018)
h = 0.6766#0.7
Om = 0.3111#0.3
Ob = 0.049#0.0465
OL = 0.6888#0.7
...
gvdb_mm = np.load('SatGen/etc/gvdb_mm.npy')
gvdb_sm = np.load('SatGen/etc/gvdb_sm.npy')
gvdb_pm = np.load('SatGen/etc/gvdb_pm.npy')
nfb = 100
nr = 131
ncs = 30
...
jiang_cdfs = np.load('SatGen/etc/jiang_cdfs.npz')
